...
const DiamondManager = () => {
    ...
    const handleDetailClick = async (id) => {
        try {
            ...
            const res = await axios.get(`https://jssatsproject.azurewebsites.net/api/diamond/getById?id=${id}`, {
                headers: {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen">
            <div>
                <h1 className="text-2xl font-bold text-center mb-4">List of diamond</h1>
