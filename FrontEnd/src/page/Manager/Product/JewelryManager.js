...
const JewelryManager = () => {
    ...
    const getProduct = async () => {
        try {
            ...
            if (res && res.data && res.data.data) {
                ...
                const jewelryProducts = allProducts.filter(product => product.categoryId <= 4);
                setListProduct(jewelryProducts);
                setOriginalListProduct(jewelryProducts);
            }
        } catch (error) {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-white mx-5 pt-5 mb-5 rounded">
            <div>
                <h1 className="text-3xl font-bold text-center text-blue-800 mb-4 underline">List of jewelry</h1>
                    ...
                    {selectedJewelry && (
                        <div className="fixed inset-0 flex items-center justify-center z-10 bg-gray-800 bg-opacity-50">
                            <div className="bg-white rounded-lg p-8 w-[600px]">
                                <h2 className="text-xl text-blue-600 text-center font-bold mb-4">{selectedJewelry.name}</h2>
                                <div className='flex'>
                                    <div className='w-1/2'>
