                                ...
                                {updateOrDetail === 'detail' && (
                                    <>
                                        ...
                                        <div className="grid grid-cols-2">
                                            ...
                                            <p className="border p-2">{selectedWholesaleGold.id}</p>

                                            <p className="border p-2"><strong>Code:</strong></p>
                                            <p className="border p-2">{selectedWholesaleGold.code}</p>


                                            <p className="border p-2"><strong>Material:</strong></p>
                                            <p className="border p-2">{selectedWholesaleGold.materialName}</p>

                                            <p className="border p-2"><strong>Material Weight:</strong></p>
                                            <p className="border p-2">{selectedWholesaleGold.materialWeight}</p>

                                            <p className="border p-2"><strong>Price Rate:</strong></p>
                                            <p className="border p-2">{selectedWholesaleGold.priceRate}</p>

                                            <p className=" border p-2"><strong>Price:</strong></p>
                                            <p className=" border p-2 ">{formatCurrency(selectedWholesaleGold.productValue)}</p>
                                        </div>
                                        <div className="">
                                            <button
                                                onClick={closeModal}
