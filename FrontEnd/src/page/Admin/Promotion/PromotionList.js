...
//       <div>
//         <h1 className="text-3xl font-bold text-center text-blue-800 mb-4">Promotion list</h1>
...
//                   </td>
//                   <td className="text-2xl text-sky-300 pl-4"><FiEdit3 onClick={() => handleDetailClick(item)} /></td>
