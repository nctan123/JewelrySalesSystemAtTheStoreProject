                          ...
                          <div className='flex justify-center items-center fixed top-0 bottom-0 left-0 p-2'>
                            <div className='bg-[#fff] my-[70px] mx-auto rounded-md w-[100%] shadow-[#b6b0b0] shadow-md'>
                              <form className="p-4 md:p-5 relative">
                                ...
                                <button onClick={(event) => { handleDetailClick(event); }} className="mb-0 text-white flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-4 text-center">
                                  Pay Now
                                </button>
                              </form>
                            </div>
                                  ...
                                  <table className="min-w-full text-left text-sm font-light text-gray-900">
                                    ...
                                    <tbody>
                                      <tr className="border-b bg-gray-50">
                                        ...
                                        <td className="whitespace-nowrap px-6 py-4">Otto Mark Mark</td>
                                        <td className="whitespace-nowrap px-4 py-4 text-center">1</td>
                                        <td className="whitespace-nowrap px-6 py-4 text-right">1.000.000</td>
                                        <td className="whitespace-nowrap px-6 py-4 text-right">1.000.000</td>
                                      </tr>
                                      <tr className="border-b bg-gray-50">
                                        <td className="whitespace-nowrap px-4 py-4 text-center font-medium">1</td>
