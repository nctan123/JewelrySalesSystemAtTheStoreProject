...
namespace JSSATSProject.Service.Service.IService
{
    ...
    {
        public Task<ResponseModel> GetAllAsync(DateTime startDate, DateTime endDate, int pageIndex, int pageSize, string sortBy, bool ascending);
        ...
        public Task<ResponseModel> SearchAsync(string nameSearch, DateTime startDate, DateTime endDate, int pageIndex, int pageSize);
    }
}